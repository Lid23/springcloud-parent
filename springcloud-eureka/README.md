...
## 项目启动
 ...
 - 启动服务：
  ```
nohup java -Xms512m -Xmx1024m -jar microservice-eureka.jar --spring.profiles.active=dev-8101 &
nohup java -Xms512m -Xmx1024m -jar microservice-eureka.jar --spring.profiles.active=dev-8102 &
nohup java -Xms512m -Xmx1024m -jar microservice-eureka.jar --spring.profiles.active=dev-8103 &

# 虚拟机参数启动
-Dspring.profiles.active=dev-8101
-Dspring.profiles.active=dev-8102
-Dspring.profiles.active=dev-8103
 ```
